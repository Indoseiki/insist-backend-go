...
func (s *SubSectionService) GetTotal(search string) (int64, error) {
	var count int64
...
func (s *SubSectionService) GetAll(offset, limit int, search string, sortBy string, sortDirection bool) ([]model.MstSubSection, error) {
